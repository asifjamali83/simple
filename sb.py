...
print ("=== LOGIN SUCCES ===\n =[Sepri bot siap digunakan]=\n =TEAM Musibat BOT PROTECTION=")
#===============================#
oepoll = OEPoll(sepri)
call = (sepri)
mid = sepri.getProfile().mid
Bots = [mid]
creator = ["u7db43f5dd3221b670f042ae325c54042"]
owner = ["u7db43f5dd3221b670f042ae325c54042"]
admin = ["u7db43f5dd3221b670f042ae325c54042"]
staff = ["u7db43f5dd3221b670f042ae325c54042"]
#===============================#
myProfile = {
	"displayName": "",
	"statusMessage": "",
                    ...
                    if msg_id in msg_dict:
                        if msg_dict[msg_id]["from"]:
                           if msg_dict[msg_id]["text"] == 'Gambarnya dibawah':
                                ...
                                ginfo = sepri.getGroup(at)
                                Sepriche = sepri.getContact(msg_dict[msg_id]["from"])
                                ret_ =  "✍͡➴͜➣ 「 Pesan Dihapus 」\n"
                                ret_ += "✍͡➴͜➣  Pengirim : {}".format(str(sepri.displayName))
                                ret_ += "\n✍͡➴͜➣ Nama Grup : {}".format(str(ginfo.name))
                                ret_ += "\n✍͡➴͜➣ Waktu Ngirim : {}".format(dt_to_str(cTime_to_datetime(msg_dict[msg_id]["createdTime"])))
                                ret_ += "\n✍͡➴͜➣ Pesannya : {}".format(str(msg_dict[msg_id]["text"]))
           ...
           if wait["selfbot"] == True:
                 ...
                 if wait["Mentiongift"] == True:
                   ...
                   for mention in mentionees:
                        if mention ['M'] in Bots:
                           ...
                           sepri.sendMessage(msg.to, " ✍͡➴͜➣sukses send gift\ncek pm😛.")
               ...
               if msg.contentType == 7:
                 if wait["sticker"] == True:
                    msg.contentType = 0
                    sepri.sendMessage(msg.to,"「Cek ID Sticker」\n=  STKID : " + msg.contentMetadata["STKID"] + "\n✍͡➴͜➣  STKPKGID : " + msg.contentMetadata["STKPKGID"] + "\n✍͡➴͜➣  STKVER : " + msg.contentMetadata["STKVER"]+ "\n\n「Link Sticker」" + "\nline://shop/detail/" + msg.contentMetadata["STKPKGID"])
               if msg.contentType == 13:
                 if wait["contact"] == True:
                    ...
                    if 'displayName' in msg.contentMetadata:
                        ...
                        sepri.sendMessage(msg.to,"✍͡➴͜➣  Nama : " + msg.contentMetadata["displayName"] + "\n✍͡➴͜➣  MID : " + msg.contentMetadata["mid"] + "\n✍͡➴͜➣  Status : " + contact.statusMessage + "\n✍͡➴͜➣  Picture URL : http://dl.profile.line-cdn.net/" + contact.pictureStatus)
                        sepri.sendImageWithURL(msg.to, image)
                 ...
                 if msg._from in admin:
                  if wait["addbots"] == True:
                    if msg.contentMetadata["mid"] in Bots:
                        ...
                        wait["addbots"] = True
                        sepri.sendMessage(msg.to,"Added successfully ke anggota bot")
                 if wait["dellbots"] == True:
                    if msg.contentMetadata["mid"] in Bots:
                        Bots.remove(msg.contentMetadata["mid"])
                        sepri.sendMessage(msg.to,"Successfully remove dari anggota bot")
                    else:
                        wait["dellbots"] = True
                 ...
                 if msg._from in admin:
                  if wait["addstaff"] == True:
                    if msg.contentMetadata["mid"] in staff:
                        ...
                        wait["addstaff"] = True
                        sepri.sendMessage(msg.to,"Added successfully ke staff")
                 if wait["dellstaff"] == True:
                    if msg.contentMetadata["mid"] in staff:
                        staff.remove(msg.contentMetadata["mid"])
                        sepri.sendMessage(msg.to,"Successfully remove dari staff")
                        wait["dellstaff"] = True
                    else:
                        wait["dellstaff"] = True
                 ...
                 if msg._from in admin:
                  if wait["addadmin"] == True:
                    if msg.contentMetadata["mid"] in admin:
                        ...
                        wait["addadmin"] = True
                        sepri.sendMessage(msg.to,"Added successfully ke admin")
                 if wait["delladmin"] == True:
                    if msg.contentMetadata["mid"] in admin:
                        admin.remove(msg.contentMetadata["mid"])
                        sepri.sendMessage(msg.to,"Successfully remove dari admin")
                    else:
                        wait["delladmin"] = True
                 ...
                 if msg._from in admin:
                  if wait["wblacklist"] == True:
                    if msg.contentMetadata["mid"] in wait["blacklist"]:
                        ...
                        wait["wblacklist"] = True
                        sepri.sendMessage(msg.to,"Added successfully ke blacklist user")
                  if wait["dblacklist"] == True:
                    if msg.contentMetadata["mid"] in wait["blacklist"]:
                        del wait["blacklist"][msg.contentMetadata["mid"]]
                        sepri.sendMessage(msg.to,"Successfully remove dari blacklist user")
                    else:
                 ...
                 if msg._from in admin:
                  if wait["Talkwblacklist"] == True:
                    if msg.contentMetadata["mid"] in wait["Talkblacklist"]:
                        ...
                        wait["Talkwblacklist"] = True
                        sepri.sendMessage(msg.to,"Added successfully ke Talkban user")
                  if wait["Talkdblacklist"] == True:
                    if msg.contentMetadata["mid"] in wait["Talkblacklist"]:
                        del wait["Talkblacklist"][msg.contentMetadata["mid"]]
                        sepri.sendMessage(msg.to,"Successfully remove dari Talkban user")
                    else:
                 ...
                 if msg._from in admin:
                    if Setmain["Addimage"] == True:
                        ...
                        if r.status_code == 200:
                            ...
                            sepri.sendMessage(msg.to, "Added successfully gambar")
                        Setmain["Img"] = {}
               ...
               if msg.toType == 2:
                 if msg._from in admin:
                   if settings["groupPicture"] == True:
                     ...
                     sepri.sendMessage(msg.to, "Successfully mengubah foto group")
               ...
               if msg.contentType == 1:
                   if msg._from in admin:
                       if mid in Setmain["SCfoto"]:
                            ...
                            sepri.sendMessage(msg.to,"Foto Successfully dirubah")
               ...
               if msg.contentType == 0:
                    ...
                    if text is None:
                        ...
                        if cmd == "self on":
                            if msg._from in admin:
                                wait["selfbot"] = True
                                sepri.sendMessage(msg.to, "✍͡➴͜➣ Selfbot activated")
                                
                        elif cmd == "self off":
                            if msg._from in admin:
                                wait["selfbot"] = False
                                sepri.sendMessage(msg.to, "✍͡➴͜➣ Selfbot dinonaktifkan")
                        ...
                        if cmd == "unsend on":
                            if msg._from in admin:
                                wait["unsend"] = True
                                sepri.sendMessage(msg.to, "✍͡➴͜➣ Deteksi Unsend activated")
                                
                        if cmd == "unsend off":
                            if msg._from in admin:
                                wait["unsend"] = False
                                sepri.sendMessage(msg.to, "✍͡➴͜➣ Deteksi Unsend Dinonaktifkan")                                
                        ...
                        elif cmd == "Musibat" or text.lower() == 'Musibat':
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               try:
                                   ...
                                   sepri.sendMessage(msg.to,"✍͡➴͜➣ Chat dibersihkan...")
                               except:
                                   pass
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in creator:
                               sepri.sendMessage(msg.to, "✍͡➴͜➣ Restart Sukses")
                          ...
                          if msg._from in admin:
                            ...
                            try:
                                ...
                                timeCreated = []
                                timeCreated.append(time.strftime("%d-%m-%Y [ %H:%M:%S ]", time.localtime(int(G.createdTime) / 1000)))
                                ret_ += "✍͡➴͜➣  BOT Grup Info\n"
                                ret_ += "\n✍͡➴͜➣  Name : {}".format(G.name)
                                ret_ += "\n✍͡➴͜➣  ID : {}".format(G.id)
                                ret_ += "\n✍͡➴͜➣  Creator : {}".format(gCreator)
                                ret_ += "\n✍͡➴͜➣  Created Time : {}".format(str(timeCreated))
                                ret_ += "\n✍͡➴͜➣  Member : {}".format(str(len(G.members)))
                                ret_ += "\n✍͡➴͜➣  Pending : {}".format(gPending)
                                ret_ += "\n✍͡➴͜➣  Qr : {}".format(gQr)
                                ret_ += "\n✍͡➴͜➣  Ticket : {}".format(gTicket)
                                ret_ += ""
                          ...
                          if msg._from in admin:
                            ...
                            try:
                                ...
                                for mem in G.members:
                                    no += 1
                                    ret_ += "\n " "✍͡➴͜➣  "+ str(no) + ". " + mem.displayName
                                sepri.sendMessage(to,"✍͡➴͜➣  Group Name : [ " + str(G.name) + " ]\n\n   [ List Member ]\n" + ret_ + "\n\n「Total %i Members」" % len(G.members))
                            except: 
                                pass
                          ...
                          if msg._from in admin:
                            ...
                            for i in group:
                                ...
                                if ginfo == group:
                                    ki.leaveGroup(i)
                                    sepri.sendMessage(msg.to,"Successfully keluar di grup " +str(ginfo.name))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              ...
                              if ginvited != [] and ginvited != None:
                                  ...
                                  sepri.sendMessage(msg.to, "✍͡➴͜ Succes Reject {} Group Invite".format(str(len(ginvited))))
                              else:
                                  sepri.sendMessage(msg.to, "✍͡➴͜no thing")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              if msg.toType == 2:
                                ...
                                sepri.sendMessage(msg.to,"Send Photo.....")

                        elif cmd == "updatebot":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                settings["changePicture"] = True
                                ki.sendMessage(msg.to,"Send Photo.....")
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                sepri.sendMessage(msg.to,"✍͡➴͜➣  BOT\n\n"+ma+"\nTotal「%s」BOT" %(str(len(Bots))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                sepri.sendMessage(msg.to,"✍͡➴͜➣  Admin ❍✯͜͡ˢᵉᵖʳⁱBOT\n\n✍͡➴͜➣ Creator BOT:\n"+ma+"\n✍͡➴͜➣ Admin:\n"+mb+"\n✍͡➴͜➣ Staff:\n"+mc+"\n✍͡➴͜➣ Total「%s」" %(str(len(owner)+len(admin)+len(staff))))
                            ...
                            if msg._from in admin:
                                ...
                                for i in gid:
                                    ...
                                    if h == ng:
                                        ...
                                        ki.leaveGroup(i)
                                        sepri.sendMessage(to,"Successfully keluar dari grup " +h)
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               start = time.time()
                               sepri.sendMessage(msg.to, "™❍✯͜͡speed...✍͡➴͜➣")
                               elapsed_time = time.time() - start
                               sepri.sendMessage(msg.to, "{} Seconds".format(str(elapsed_time)))


                        elif cmd == "Fire" or cmd == "Musibat":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               sepri.sendMessage(msg.to, """💖.M.U.S.I.B.A.T.💗.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.⭐.เอ.จัง.1.0.V.E.💗.N.e.w.2.0.2.0.💗""")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                 ...
                                 sepri.sendMessage(msg.to, "Lurking Successfully activated\n\nTanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nJam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                 ...
                                 sepri.sendMessage(msg.to, "Lurking Successfully dinoaktifkan\n\nTanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nJam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                              try:
                                  tz = pytz.timezone("Asia/Jakarta")
                                  timeNow = datetime.now(tz=tz)
                                  sepri.sendMessage(msg.to, "✍͡➴͜➣Cek sider activated\n\nTanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nJam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                              if msg.to in cctv['point']:
                                  ...
                                  sepri.sendMessage(msg.to, "✍͡➴͜➣Cek sider dinonaktifkan\n\nTanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nJam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                             if msg.toType == 2:
                                ...
                                jmlh = int(wait["limit"])
                                sepri.sendMessage(msg.to, "Successfully mengundang {} undangan Call Grup".format(str(wait["limit"])))
                                if jmlh <= 1000:
                                  for x in range(jmlh):
                                     try:
                           ...
                           if msg._from in admin:
                              ...
                              if spl == 'on':
                                  if msg.to in welcome:
                                       msgs = "✍͡➴͜➣ Welcome Msg sudah aktif"
                                  else:
                                       welcome.append(msg.to)
                                       ginfo = sepri.getGroup(msg.to)
                                       msgs = "Welcome Msg activated\nDi Group : " +str(ginfo.name)
                                  sepri.sendMessage(msg.to, "「activated」\n" + msgs)
                              elif spl == 'off':
                                    if msg.to in welcome:
                                         ...
                                         msgs = "✍͡➴͜➣ Welcome Msg sudah tidak aktif"
                           ...
                           if msg._from in admin:
                              ...
                              if spl == 'on':
                                  if msg.to in protectqr:
                                       msgs = "✍͡➴͜➣ Protect url sudah aktif"
                                  else:
                                       protectqr.append(msg.to)
                                       ginfo = sepri.getGroup(msg.to)
                                       msgs = "✍͡➴͜➣ Protect url activated\nDi Group : " +str(ginfo.name)
                                  sepri.sendMessage(msg.to, "「activated」\n" + msgs)
                              elif spl == 'off':
                                    if msg.to in protectqr:
                                         ...
                                         msgs = "✍͡➴͜➣ Protect url sudah tidak aktif"
                                    sepri.sendMessage(msg.to, "「Dinonaktifkan」\n" + msgs)
                           ...
                           if msg._from in admin:
                              ...
                              if spl == 'on':
                                  if msg.to in protectkick:
                                       msgs = "✍͡➴͜➣ Protect kick sudah aktif"
                                  else:
                                       protectkick.append(msg.to)
                                       ginfo = sepri.getGroup(msg.to)
                                       msgs = "✍͡➴͜➣ Protect kick activated\nDi Group : " +str(ginfo.name)
                                  sepri.sendMessage(msg.to, "「activated」\n" + msgs)
                              elif spl == 'off':
                                    if msg.to in protectkick:
                                         protectkick.remove(msg.to)
                                         ginfo = sepri.getGroup(msg.to)
                                         msgs = "✍͡➴͜➣Protect kick dinonaktifkan\nDi Group : " +str(ginfo.name)
                                    else:
                                         msgs = "✍͡➴͜➣Protect kick sudah tidak aktif"
                                    sepri.sendMessage(msg.to, "「Dinonaktifkan」\n" + msgs)
                           ...
                           if msg._from in admin:
                              ...
                              if spl == 'on':
                                  if msg.to in protectjoin:
                                       msgs = "✍͡➴͜➣ Protect join sudah aktif"
                                  else:
                                       protectjoin.append(msg.to)
                                       ginfo = sepri.getGroup(msg.to)
                                       msgs = "✍͡➴͜➣ Protect join activated\nDi Group : " +str(ginfo.name)
                                  sepri.sendMessage(msg.to, "「activated」\n" + msgs)
                              elif spl == 'off':
                                    if msg.to in protectjoin:
                                         protectjoin.remove(msg.to)
                                         ginfo = sepri.getGroup(msg.to)
                                         msgs = "✍͡➴͜➣ Protect join dinonaktifkan\nDi Group : " +str(ginfo.name)
                                    else:
                                         msgs = "✍͡➴͜➣ Protect join sudah tidak aktif"
                                    sepri.sendMessage(msg.to, "「Dinonaktifkan」\n" + msgs)
                           ...
                           if msg._from in admin:
                              ...
                              if spl == 'on':
                                  if msg.to in protectcancel:
                                       msgs = "✍͡➴͜➣ Protect cancel sudah aktif"
                                  else:
                                       protectcancel.append(msg.to)
                                       ginfo = sepri.getGroup(msg.to)
                                       msgs = "✍͡➴͜➣ Protect cancel activated\nDi Group : " +str(ginfo.name)
                                  sepri.sendMessage(msg.to, "「activated」\n" + msgs)
                              elif spl == 'off':
                                    if msg.to in protectcancel:
                                         protectcancel.remove(msg.to)
                                         ginfo = sepri.getGroup(msg.to)
                                         msgs = "✍͡➴͜➣Protect cancel dinonaktifkan\nDi Group : " +str(ginfo.name)
                                    else:
                                         msgs = "✍͡➴͜➣Protect cancel sudah tidak aktif"
                                    sepri.sendMessage(msg.to, "「Dinonaktifkan」\n" + msgs)
                           ...
                           if msg._from in admin:
                              ...
                              if spl == 'on':
                                  if msg.to in protectinvite:
                                       msgs = "✍͡➴͜➣ Protect invite sudah aktif"
                                  else:
                                       protectinvite.append(msg.to)
                                       ginfo = sepri.getGroup(msg.to)
                                       msgs = "✍͡➴͜➣ Protect invite activated\nDi Group : " +str(ginfo.name)
                                  sepri.sendMessage(msg.to, "「activated」\n" + msgs)
                              elif spl == 'off':
                                    if msg.to in protectinvite:
                                         protectinvite.remove(msg.to)
                                         ginfo = sepri.getGroup(msg.to)
                                         msgs = "✍͡➴͜➣Protect invite dinonaktifkan\nDi Group : " +str(ginfo.name)
                                    else:
                                         msgs = "✍͡➴͜➣Protect invite sudah tidak aktif"
                                    sepri.sendMessage(msg.to, "「Dinonaktifkan」\n" + msgs)                                                                      
                           ...
                           if msg._from in admin:
                              ...
                              if spl == 'on':
                                  ...
                                  if msg.to in protectcancel:
                                      ...
                                      protectcancel.append(msg.to)
                                      ginfo = sepri.getGroup(msg.to)
                                      msgs = "Successfully mengaktifkan semua protect\nDi Group : " +str(ginfo.name)
                                  sepri.sendMessage(msg.to, "「activated」\n" + msgs)
                              elif spl == 'off':
                                    if msg.to in protectqr:
                                         protectqr.remove(msg.to)
                                    ...
                                    if msg.to in protectcancel:
                                         protectcancel.remove(msg.to)
                                         ginfo = sepri.getGroup(msg.to)
                                         msgs = "Successfully menonaktifkan semua protect\nDi Group : " +str(ginfo.name)
                                    else:
                                         ginfo = sepri.getGroup(msg.to)
                            ...
                            if msg._from in creator:
                               ...
                               for target in targets:
                                       try:
                                           ...
                                           sepri.sendMessage(msg.to,"Added successfully admin")
                                       except:
                                           pass
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               for target in targets:
                                       try:
                                           staff.append(target)
                                           sepri.sendMessage(msg.to,"Added successfully staff")
                                       except:
                                           pass
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               for target in targets:
                                       try:
                                           Bots.append(target)
                                           sepri.sendMessage(msg.to,"Added successfully bot")
                                       except:
                                           pass
                            ...
                            if msg._from in creator:
                               ...
                               for target in targets:
                                       try:
                                           ...
                                           f=codecs.open('admin.json','w','utf-8')
                                           json.dump(admin, f, sort_keys=True, indent=4,ensure_ascii=False)                                            
                                           sepri.sendMessage(msg.to,"Successfully remove admin")
                                       except:
                                           pass
                            ...
                            if msg._from in admin:
                                ...
                                sepri.sendMessage(msg.to,"Successfully di Refresh...")
...
#===========COMMAND ON OFF============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                sepri.sendMessage(msg.to,"Notag activated")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["contact"] = True
                                sepri.sendMessage(msg.to,"Deteksi contact activated")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                sepri.sendMessage(msg.to,"✍͡➴͜➣ Auto respon activated")

                        elif cmd == "respon off" or text.lower() == 'respon off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["detectMention"] = False
                                sepri.sendMessage(msg.to,"✍͡➴͜➣ Auto respon dinonaktifkan")
                                
                        elif cmd == "respongift on" or text.lower() == 'respongift on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["Mentiongift"] = True
                                sepri.sendMessage(msg.to,"✍͡➴͜➣ Auto respon gift activated")

                        elif cmd == "respongift off" or text.lower() == 'respongift off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["Mentiongift"] = False
                                sepri.sendMessage(msg.to,"✍͡➴͜➣ Auto respon gift dinonaktifkan")                                

                        elif cmd == "autojoin on" or text.lower() == 'autojoin on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoJoin"] = True
                                sepri.sendMessage(msg.to,"✍͡➴͜➣ Autojoin activated")

                        elif cmd == "autojoin off" or text.lower() == 'autojoin off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoJoin"] = False
                                sepri.sendMessage(msg.to,"✍͡➴͜➣ Autojoin dinonaktifkan")

                        elif cmd == "autoleave on" or text.lower() == 'autoleave on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoLeave"] = True
                                sepri.sendMessage(msg.to,"✍͡➴͜➣ Auto Leave activated")

                        elif cmd == "autoleave off" or text.lower() == 'autoleave off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoLeave"] = False
                                sepri.sendMessage(msg.to,"✍͡➴͜➣ Auto Leave Turn off")

                        elif cmd == "autoadd on" or text.lower() == 'autoadd on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoAdd"] = True
                                sepri.sendMessage(msg.to,"✍͡➴͜➣ Auto Add activated")

                        elif cmd == "autoadd off" or text.lower() == 'autoadd off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["autoAdd"] = False
                                sepri.sendMessage(msg.to,"✍͡➴͜➣ Auto Add Turn off")

                        elif cmd == "sticker on" or text.lower() == 'sticker on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["sticker"] = True
                                sepri.sendMessage(msg.to,"✍͡➴͜➣ Detect Sticker activated")

                        elif cmd == "sticker off" or text.lower() == 'sticker off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["sticker"] = False
                                sepri.sendMessage(msg.to,"✍͡➴͜➣ Detect Sticker Turn off")

                        elif cmd == "jointicket on" or text.lower() == 'jointicket on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                settings["autoJoinTicket"] = True
                                sepri.sendMessage(msg.to,"✍͡➴͜➣ Auto Join Ticket activated")

                        elif cmd == "jointicket off" or text.lower() == 'jointicket off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                settings["autoJoinTicket"] = False
                                sepri.sendMessage(msg.to,"✍͡➴͜➣ Auto Join Ticket Turn off")
...
#===========COMMAND BLACKLIST============#
                            ...
                            if msg._from in admin:
                               ...
                               for target in targets:
                                       try:
                                           ...
                                           sepri.sendMessage(msg.to,"Added successfully blacklist")
                                       except:
                                           pass
                            ...
                            if msg._from in admin:
                               ...
                               for target in targets:
                                       try:
                                           ...
                                           sepri.sendMessage(msg.to,"Successfully remove blacklist")
                                       except:
                                           pass
                            ...
                            if msg._from in admin:
                              if wait["blacklist"] == {}:
                                ...
                                for m_id in wait["blacklist"]:
                                    ...
                                    ma += str(a) + ". " +sepri.getContact(m_id).displayName + "\n"
                                sepri.sendMessage(msg.to,"✍͡➴͜➣  Blacklist User\n\n"+ma+"\nTotal「%s」Blacklist User" %(str(len(wait["blacklist"]))))
                            ...
                            if msg._from in admin:
                              if wait["Talkblacklist"] == {}:
                                ...
                                for m_id in wait["Talkblacklist"]:
                                    ...
                                    ma += str(a) + ". " +sepri.getContact(m_id).displayName + "\n"
                                sepri.sendMessage(msg.to,"✍͡➴͜➣  Talkban User\n\n"+ma+"\nTotal「%s」Talkban User" %(str(len(wait["Talkblacklist"]))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              ...
                              sepri.sendMessage(msg.to,"✍͡➴͜➣ Sukses Clear " +mc)
#===========COMMAND SET============#
